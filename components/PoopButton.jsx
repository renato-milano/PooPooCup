...
const PoopButton = () => {
  ...
  return (
    <View className="rounded-xl flex-1 h-[10vh] items-center">
      {!poopStatus ? (
        <MessageBox
          image={images.PooSurprise}
          text={"Hey, come mai da queste parti? Aspetta, non dirmi che..."}
        ></MessageBox>
      ) : (
        <MessageBox
          image={images.PooLove}
          text={"Ma è FANTASTICO! Aggiorno subito il tuo punteggio!"}
        ></MessageBox>
      )}
      ...
      <TouchableOpacity onPress={PressedYes} className="items-center">
        ...
        ></Image>
        <Text className="text-xl font-bregular text-white">
          Tocca Poop se hai appena cagato!{" "}
        </Text>
      </TouchableOpacity>
    </View>
  );
